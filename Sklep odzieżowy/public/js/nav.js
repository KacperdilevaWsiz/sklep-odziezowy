...
const createNavbar = () => {
  ...
  navbar.innerHTML += `
        ...
        <li class="link-item"><a href="#" class="link active">Strona główna</a></li>
            <li class="link-item"><a href="#" class="link">Katalog</a></li>
            <li class="link-item"><a href="#" class="link">O nas</a></li>
            <li class="link-item"><a href="#" class="link">Kontakt</a></li>
        </ul>
        <div class="user-interactions">
            <div class="search-box">
                <input type="text" class="search" placeholder="wyszukaj produkt">
...
// wyskakujące okienko ikony użytkownika
